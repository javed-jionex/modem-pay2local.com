...
@Component({
  selector: "app-withdrawals-transactions-search",
  templateUrl: "./withdrawals-transactions-search.component.html",
  styleUrls: ["./withdrawals-transactions-search.component.css"],
})
export class WithdrawalsTransactionsSearchComponent {
  ...
  dateFilterSearch() {
    ...
    if (this.dateTimeData?.type == "TrxWithdrawal") {
